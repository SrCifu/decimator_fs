            ...
            $.each(json, function (key, val) {
                ...
                if (val.sevende) {
                    if (val.stockalm > 0 || val.controlstock) {
                        var funcion = "add_articulo('" + val.referencia + "','" + descripcion + "','" + val.pvp.toFixed(2) + "','"
                                + val.dtopor + "','" + val.codimpuesto + "','" + val.cantidad + "')";

                        if (val.tipo) {
                            funcion = "add_articulo_" + val.tipo + "('" + val.referencia + "','" + descripcion + "','"
                                    + val.pvp.toFixed(2) + "','" + val.dtopor + "','" + val.codimpuesto + "','" + val.cantidad + "')";
                        }
                    } else {
            ...
            $.each(json, function (key, val) {
                if (val.codbarras == document.f_tpv.codbar.value) {
                    if (val.sevende && (val.stockalm > 0 || val.controlstock)) {
                        var funcion = "add_articulo('" + val.referencia + "','" + Base64.encode(val.descripcion) + "','" + val.pvp.toFixed(2) + "','"
                                + val.dtopor + "','" + val.codimpuesto + "','" + val.cantidad + "')";
